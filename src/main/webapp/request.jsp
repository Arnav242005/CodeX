...
<head>
    ...
    .launch-form-container input[type="text"],
    .launch-form-container input[type="email"],
    .launch-form-container input[type="file"] {
      width: 100%;
      padding: 10px 12px;
      margin-bottom: 20px;
    ...
    .launch-form-container input[type="submit"] {
      width: 100%;
      padding: 12px;
    ...
    .launch-form-container input[type="submit"]:hover {
...
<body>
  ...
  <h2>Project Launch Request</h2>
  <form action="requestLaunch" method="POST" enctype="multipart/form-data">
    ...
    <label for="textfile">Insert File with Overall Details:</label>
