...
<head>
    ...
    <style>
    	.signup-form-wrapper {
    max-width: 420px;
    margin: 40px auto; /* Centers only the container */
    padding: 20px;
...
#mentorSignupForm input[type="text"],
#mentorSignupForm input[type="email"] {
    width: 100%;
    padding: 10px;
    margin-bottom: 15px;
...
#mentorSignupForm input[type="submit"] {
    width: 100%;
    padding: 12px;
...
#mentorSignupForm input[type="submit"]:hover {
...
<div class="signup-form-wrapper">
    <form action="signupMentorServlet" method="post" id="mentorSignupForm">
        <h2>Signup Mentor</h2>
        ...
        <input type="text" name="gitlink" placeholder="GitHub Profile Link" required>

        <label for="phone">Phone No:</label>
        <input type="text" name="phone" required>

        <label for="availability">Availability:</label>
        <input type="text" name="availability" placeholder="e.g., Weekends, Evenings" required>
