...
<meta charset="UTF-8">
    ...
    .org-delete-form-container h2 {
      text-align: center;
      margin-bottom: 25px;
      color: #2c2c2c;
    }

    .org-delete-form-container label {
      display: block;
      margin-bottom: 8px;
      font-weight: 600;
      color: #444;
    ...
    .org-delete-form-container input[type="email"],
    .org-delete-form-container input[type="password"] {
      width: 100%;
      padding: 10px;
      margin-bottom: 20px;
    ...
    .org-delete-form-container input[type="submit"] {
      width: 100%;
      padding: 12px;
    ...
    .org-delete-form-container input[type="submit"]:hover {
...
<body>
    ...
    <div class="org-delete-form-container">
  <h2>Delete Organization</h2>
  <form action="deleteOrganizationServlet" method="post">
