...
<head>
    ...
    #organizationSignupForm h2 {
        text-align: center;
        margin-bottom: 20px;
        color: #333;
    }

    #organizationSignupForm label {
        display: block;
        font-weight: 600;
        margin-bottom: 5px;
        color: #555;
    ...
    #organizationSignupForm input[type="text"],
    #organizationSignupForm input[type="email"],
    #organizationSignupForm input[type="password"] {
        width: 100%;
        padding: 10px;
        margin-bottom: 15px;
    ...
    #organizationSignupForm input[type="submit"] {
        width: 100%;
        padding: 10px;
    ...
    #organizationSignupForm input[type="submit"]:hover {
...
<body>
    ...
    <form action="signup_organization" method="POST" id="organizationSignupForm">
        <h2>Signup Organization</h2>
